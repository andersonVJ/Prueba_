"""
Django settings for gestor_de_recursos project.
...
SECRET_KEY = 'django-insecure-mbl21v*$$nre#e6kg(6f*-74hc$pk@u#0u7q%&m)d5f2cepztc'
...
ROOT_URLCONF = 'gestor_de_recursos.urls'
